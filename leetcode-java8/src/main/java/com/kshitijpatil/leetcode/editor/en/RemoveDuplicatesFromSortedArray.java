...
// 
//
// Related Topics Array Two Pointers 👍 16307 👎 19596
...
public class RemoveDuplicatesFromSortedArray {
    public static void main(String[] args) {
        ...
        for (int[] t : testcases) {
            ...
            int uniqueCount = solution.removeDuplicates(t);
            System.out.println("#unique=" + uniqueCount);
            System.out.println("output: " + Arrays.toString(t));
        }
    }
    //leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    public int removeDuplicates(int[] nums) {
        int write=1, unique=Math.min(1, nums.length);
